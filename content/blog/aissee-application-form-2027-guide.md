...
date: 2026-07-05
draft: false
description: "Complete step-by-step guide to fill AISSEE application form 2027. Documents required, photo specifications, fee payment & common mistakes to avoid. Apply at exams.nta.nic.in."
keywords: ["AISSEE application form", "how to fill AISSEE form", "sainik school online form 2027", "AISSEE 2027 registration", "sainik school form fill up"]
author_name: "Nisha"
...
| **Last Date for Fee Payment** | November 2026 |
| **Correction Window** | November 2026 (2-3 days) |
...
|----------|--------------|--------|
| **Photograph** | Recent, passport size, white background | JPEG, 10KB-200KB |
| **Signature** | Black ink on white paper | JPEG, 4KB-30KB |
| **Aadhaar Card** | 12-digit number | Scanned copy ready |
| **Class Certificate** | Current class bonafide | PDF, max 500KB |
| **Category Certificate** | SC/ST/OBC (if applicable) | PDF, max 500KB |
| **Disability Certificate** | PwD (if applicable) | PDF, max 500KB |
| **Bank Details** | For fee refund (if needed) | Account number + IFSC |
...
1. Browser kholo: [exams.nta.nic.in/sainik-school-society/](https://exams.nta.nic.in/sainik-school-society/)
2. **"New Registration"** ya **"Apply Online"** pe click karo
3. Instructions carefully padho
4. **"Proceed to Apply"** pe click karo
...
2. **Password Create Karo:**
   - Minimum 8 characters
   - 1 uppercase + 1 lowercase + 1 number + 1 special character
   - Password save karo kahin safe jagah

3. **Submit Registration**

4. **Note Down:**
   - Application Number (bahut important — admit card ke liye)
   - Password

<div style="background: #E3F2FD; border-left: 4px solid #2196F3; padding: 16px; border-radius: 0 8px 8px 0; margin: 20px 0;">
<h4>💡 Important Note</h4>
<p>Application number aur password <strong>kahin likh lo</strong> ya screenshot le lo. Yeh admit card download karne ke liye zaroori hai. Email pe bhi aayega lekin spam folder mein ja sakta hai.</p>
</div>
...
- Apne state ka school pehle rakho (67% reservation milega)
- Second choice kisi aur state ka school rakh sakte ho
- Third choice optional hai

**Section 6: Upload Documents**
- Photograph upload karo (specifications ke according)
- Signature upload karo
- Category certificate (SC/ST/OBC ke liye)
- Disability certificate (PwD ke liye)
...
1. **Review** karo — sab details sahi hain?
2. **Submit** karo
3. **Confirmation Page** download karo (PDF)
...
3. Application Number + Password / DOB se login karo
4. Admit Card download karo (PDF)
5. **Print karo** (color print recommended)
...
- ✅ 2-3 Black/Blue ball point pens
- ✅ Passport size photo (extra, backup ke liye)
...
### Form fill karne ke liye kya age chahiye?
- **Class 6:** 10-12 years as on March 31, 2027 (Born: April 1, 2015 to March 31, 2017)
...
Usually **exam se 1-2 hafte pehle** admit card release hota hai. December end ya January beginning mein. NTA website se download karna hota hai.

### Ek se zyada baar form bhar sakte hain?
Nahi, ek student sirf **ek baar** form bhar sakta hai. Multiple applications submit karne pe sab reject ho jaayenge.
